% source: https://github.com/klb2/review-response-template
\documentclass[11pt,american]{scrartcl}
\usepackage{babel}
\usepackage[babel]{microtype}
\usepackage[babel]{csquotes}

\usepackage[journal={Journal of Informetrics},
			manuscript={JOI-D-23-00570},
			editor={Prof.\ Huang}]{reviewresponse}
...
\usepackage[backend=biber,style=apa,dashed=false,url=false,isbn=false,defernumbers=true,refsection=section,natbib=true]{biblatex}
\bibliography{TeX}
